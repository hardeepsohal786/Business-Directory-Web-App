  ...
  return (
    <nav className="bg-white shadow-md px-6 py-4 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="text-xl font-bold text-blue-600">BizDial</div>
        <button
        ...
        >
          {token ? (
            <>
              ...
              <Link to="/dashboard/business/profile" className="block hover:text-blue-600">Edit Profile</Link>
              <Link to="/dashboard/business/products" className="block hover:text-blue-600">Manage Products</Link>
              <Link to="/dashboard/business/stats" className="block hover:text-blue-600">Financial Stats</Link>
